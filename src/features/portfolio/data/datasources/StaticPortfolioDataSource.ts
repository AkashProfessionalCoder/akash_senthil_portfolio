    ...
    return {
      ...
      impactStats: [
        ...
        },
        {
          ...
          details: ['Samaaro attendee Application', 'Samaaro Reception Dashboard', 'Apex Invest', 'Apex Group', 'Pepsico'],
        },
      ],
      projects: [
        {
      ...
      journey: [
        {
          ...
          companyUrl: 'https://whyglobalservices.com/',
          logoUrl: 'https://logo.clearbit.com/whyglobalservices.com',
          workDone: [
        ...
        },
        {
          ...
          companyUrl: 'https://www.samaaro.com/',
          logoUrl: 'https://logo.clearbit.com/samaaro.com',
          workDone: [
      ...
      notes: [
        {
          ...
          date: 'Nov 22, 2025',
          readTime: '8 min read',
          link: 'https://medium.com/nammaflutter/deeplinking-in-flutter-ad5a40759ef3',
        },
        {
          id: 'note-2',
          title: 'Mobile CI/CD - Automate Flutter iOS Releases to the App Store Using Fastlane',
          subtitle: 'Automate flutter ios release process to the app store using fastlane',
          date: 'March 10, 2026',
          readTime: '6 min read',
          link: 'https://medium.com/nammaflutter/automate-flutter-ios-releases-to-the-app-store-using-fastlane-step-by-step-guide-6a935f6c6b10',
        },
        {
          id: 'note-3',
          ...
          date: 'Mar 23, 2026',
          readTime: '4 min read',
          link: 'https://medium.com/nammaflutter/even-experinced-devs-ignore-security-10-best-practices-for-production-flutter-apps-android-e2a34b944ac3',
        },
        {
          id: 'note-4',
          title: 'Dio vs HTTP in Flutter - Why and How to Use Dio Efficiently',
          subtitle: 'Under the hood of Flutter rendering: reducing rebuilds, optimizing lists, and profiling memory leaks.',
          date: 'Nov 24 5, 2025',
          readTime: '4 min read',
          link: 'https://medium.com/nammaflutter/dio-vs-http-in-flutter-why-and-how-to-use-dio-efficiently-f13089b4ea83',
        },
      ],
      community: {
        id: 'comm-1',
